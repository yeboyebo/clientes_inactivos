...
# @class_declaration clientes_inactivos_agentes #
class clientes_inactivos_agentes(interna_agentes, helpers.MixinConAcciones):
    pass
...
class agentes(clientes_inactivos_agentes, helpers.MixinConAcciones):
    pass

...
# @class_declaration clientes_inactivos_usuarios #
class clientes_inactivos_usuarios(interna_usuarios, helpers.MixinConAcciones):
    pass
...
class usuarios(clientes_inactivos_usuarios, helpers.MixinConAcciones):
    pass
